  ...
  return (
    <Modal>
      ...
      <div className="mt-3 space-y-3 text-sm text-ink-muted">
        ...
        <p><strong className="text-ink">Joker:</strong> each round one card is set aside at random and its rank becomes that round&apos;s joker. Any card of that rank is worth 0, for both players.</p>
